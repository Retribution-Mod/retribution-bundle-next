...
import type { ComparableDependencyMap } from '@retribution-mod/modules/finders/filters'
        ...
        () => {
            ...
            const [module] = lookupModule(
                withProps<typeof ReactNativeSafeAreaContext>('SafeAreaProvider')
                    ...
                    .keyAs(
                        'Retribution.externals.ReactNativeSafeAreaContext.ReactNativeSafeAreaContext',
                    ),
            )
