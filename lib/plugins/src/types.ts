...
> {
    ...
    patcher: typeof import('@retribution-mod/patcher')
    plugins: PluginApiPlugins
    react: PluginApiReact
    assets: typeof import('@retribution-mod/assets')
...
> extends UnscopedPreInitPluginApi<O> {
    components: typeof import('@retribution-mod/components')
...
declare module '@retribution-mod/modules/native' {
    export interface NativeMethods {
        'Retribution.plugins.getConstants': [
            [],
