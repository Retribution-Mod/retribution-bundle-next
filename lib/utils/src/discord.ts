import { getAssetByName } from '@retribution-mod/assets'
import { ImportTrackerModuleId } from '@retribution-mod/discord/common/import-tracker'
import { TokensModuleId } from '@retribution-mod/discord/common/tokens'
...
>(
    ...
    names => `Retribution.utils.discord.generatedIconComponent(${names.join(',')})`,
