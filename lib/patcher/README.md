...
This source code is polished and adapted to work with Retribution. We do not claim any rights to this library. You may use it granted you follow the license.
...
```js
import { before } from '@retribution-mod/patcher'
...
```js
import { after } from '@retribution-mod/patcher'
...
```js
import { before, after, instead } from '@retribution-mod/patcher'
...
```js
import { before, after, instead, HookPriority } from '@retribution-mod/patcher'
