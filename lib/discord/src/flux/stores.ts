import { DispatcherModuleId } from '@retribution-mod/discord/common/flux'
...
import { isModuleExportBad } from '@retribution-mod/modules/metro/utils'
...
export const withStoreName = createFilterGenerator(
    ...
    ([name]) => `Retribution.discord.storeName(${name})`,
