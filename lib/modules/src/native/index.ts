import { getCurrentStack, getErrorStack } from '@retribution-mod/utils/error'
...
export function getBridgeInfo(): BridgeInfo | null {
    try {
        return callNativeMethodSync('Retribution.info', [])
    } catch (e) {
        nativeLoggingHook(
...
const CallableReturnNativeMethodName = 'Retribution.__callableReturn' as const
const CallableModuleName = 'RetributionBridge'
