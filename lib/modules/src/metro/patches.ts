import { onAnyModuleFirstRequired } from '@retribution-mod/modules/metro/subscriptions'
...
import type { Metro, RetributionMetro } from '../types'
...
export const mList: RetributionMetro.ModuleList = new Map()
...
): RetributionMetro.ModuleDefinition | undefined {
...
const metroDefine = (
    ...
    const def: RetributionMetro.ModuleDefinition = {
        flags: 0,
        module: undefined,
        factory: () => {
 ...
 *    - And since Retribution runs before everything else, we need to patch in the next steps:
