import defer * as Actions from '@retribution-mod/discord/actions'
import { onFluxEventDispatched } from '@retribution-mod/discord/flux'
...
import { onRunApplicationFinished } from '@retribution-mod/react/native'
import { asap } from '@retribution-mod/utils/callback'
...
registerInternalPlugin(
    {
        ...
        name: 'Recovery',
        description:
            'Handles errors and provides troubleshooting options for Retribution.',
        author: 'Retribution',
        icon: 'ShieldIcon',
        ...
        onRunApplicationFinished(() => {
            ...
            currentId = setTimeout(() => {
                ...
                try {
                    ...
                    callNativeMethod('Retribution.alertError', [text, FullVersion])
                } catch (e) {
                    console.error(
                        'Failed to call native method "Retribution.alertError":',
                        e,
                    )
                }
