...
import { ClientInfoModule } from '@retribution-mod/discord/native'
import { Clipboard } from '@retribution-mod/externals/react-native-clipboard'
import { ReactNativeSafeAreaContext } from '@retribution-mod/externals/react-native-safe-area-context'
import { reloadApp } from '@retribution-mod/modules/native/app'
import { requestNextBootDefaultsOnly } from '@retribution-mod/plugins/_'
        ...
        >
            <View style={additionalStyles.headerContainer}>
                ...
                <Text variant="text-md/normal">
                    ...
                    be caused by plugins, Retribution or Discord.
                </Text>
