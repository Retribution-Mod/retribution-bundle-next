import { AlertActionCreators } from '@retribution-mod/discord/actions'
...
import { insteadJSX } from '@retribution-mod/react/jsx-runtime'
...
registerInternalPlugin(
    {
        id: 'Retribution.user-badges',
        name: 'User Badges',
        description: 'Badges for Retribution contributors and sponsors.',
        author: 'Retribution',
        icon: 'ShieldUserIcon',
    },
    {
