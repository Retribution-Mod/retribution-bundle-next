...
import { FormSwitch } from '@retribution-mod/components'
...
import { resyncPluginSources } from '@retribution-mod/plugins/_'
import {
    listAllUpdates,
    listRepos,
    refreshAllRepos,
...
export default function RetributionPluginsAdvancedSettingScreen() {
                ...
                <Stack spacing={16} style={{ paddingBottom: 32 }}>
                    ...
                    <TableRowGroup title="Advanced">
                        <TableRow
                            ...
                            onPress={() =>
                                callNativeMethod(
                                    'Retribution.plugins.installFile',
                                    [],
                                )
                            }
                        />
