...
import { SettingListRenderer } from '@retribution-mod/discord/modules/settings/renderer'
import { Image, Linking, ScrollView, StyleSheet, View } from 'react-native'
import RetributionDonate from '~assets/RetributionDonate'
import { Setting } from '../constants'

const { Button, Card, Stack, Text } = Design

export default function RetributionSettingScreen() {
    return (
                            ...
                            sections: [
                                {
                                    label: 'Retribution',
                                    settings: [
                                        Setting.RetributionVersion,
                                        Setting.LoaderVersion,
                                        Setting.RetributionDiscord,
                                        Setting.RetributionSourceRepository,
                                        Setting.RetributionLicense,
                                    ],
                                },
                                {
                                    label: 'Versions',
                                ...
                                {
                                    label: 'Developer',
                                    settings: [Setting.RetributionDeveloperMode],
                                },
                            ],
                        }}
                    />
                    ...
                    <Stack spacing={16} style={styles.flex}>
                        <Stack spacing={6} style={styles.flex}>
                            ...
                            <Text variant="text-md/medium">
                                You can support the development of Retribution by
