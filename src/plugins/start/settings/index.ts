import { sRefresher, sSections } from '@retribution-mod/discord/_/modules/settings'
import { onSettingsModulesLoaded } from '@retribution-mod/discord/modules/settings'
import defer * as Renderer from '@retribution-mod/discord/modules/settings/renderer'
import { waitForModuleWithImportedPath } from '@retribution-mod/discord/utils/modules/finders'
import { waitForModules } from '@retribution-mod/modules/finders'
import { withName, withProps } from '@retribution-mod/modules/finders/filters'
...
import { React } from '@retribution-mod/react'
import { asap, noop } from '@retribution-mod/utils/callback'
import { getCurrentStack } from '@retribution-mod/utils/error'
import { useReRender } from '@retribution-mod/utils/react'
import { cloneElement, useEffect } from 'react'
import type { SettingsSection } from '@retribution-mod/discord/modules/settings'
import type { AnyFunction, KeyWithType } from '@retribution-mod/utils/types'
import type {
    FC,
    MemoExoticComponent,
    ReactElement,
...
const pluginSettings = registerInternalPlugin(
    {
        ...
        name: 'Settings',
        description: 'Settings UI for Retribution.',
        author: 'Retribution',
        icon: 'SettingsIcon',
    },
    {
    ...
    if (Array.isArray(children)) {
        ...
        if (index !== -1) {
            ...
            newChildren[index] = cloneElement(children[index] as ReactElement, {
                key: `Retribution.${sRefresher.navigator}`,
            })
